  ...
  data: () => ({
    ...
    contents: [
      ...
      },
      {
        ...
        subject: "Prüfung bestehen oder die Hälfte des GELDES zurück",
        description: "Ich gebe seit 14 Jahren professionelle Mathe, Statistik, Physik & Informatik Nachhilfe.",
