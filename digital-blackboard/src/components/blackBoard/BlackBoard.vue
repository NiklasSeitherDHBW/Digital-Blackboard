<template>
    <CustomAppBar titleGrey="Digital" titleRed="Blackboard" subtitle="Was geht ab?"/>
          ...
          <v-card class="mx-auto">
            ...
            <v-card-title class="d-flex align-center">
              <v-icon
                  ...
                  size="18"
              ></v-icon>
              <h4 style="color: white">{{ item.raw.name }}</h4>
            </v-card-title>
            </v-img>
            <v-list-item-subtitle style="margin-top: 10px; margin-right: 10px">{{ item.raw.date }}</v-list-item-subtitle>
            <v-card-text>
