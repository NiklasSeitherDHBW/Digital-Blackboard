...
export default {
  data: () => ({
    ...
    advertisements: [
      {
        title: 'Tauschpartner gesucht: Ab Januar 2024',
        description: 'Ich suche einen Tauschpartner im Drei-Monats-Wechsel, da ich an der DHBW studiere und alle drei Monate für drei Monate in meiner Heimat in der Praxisphase bin. Falls du genau in die entgegengesetzten Phasen passt, würde ich mich sehr über eine kurze Nachricht freuen! ',
      ...
      },
      {
        ...
        description: "Hallo, ich heiße Xenia, bin 20 Jahre alt und werde ab dem 01.10.2023 in Mannheim mit der Theoriephase meines Studiums beginnen. Ich werde aber schon im September in Mannheim mit einem 1-monatigen Praktikum starten. Mein duales Studium geht ab dem 01.09.23 bis zum 31.12.2023 in Mannheim (1.09 wegen dem Praktikum, sonst wäre es 1.10) und danach 3 Monate nicht mehr und dann 3 Monate wieder in Mannheim. Also ich bin alle 3 Monate für 3 Monate in Mannheim. Daher suche ich jemanden der genau im Gegensatz seine Praxisphase hat. Falls du Interesse hast, würde es mich freuen, wenn du dich meldest und wir gemeinsam eine Wohnung finden können :) ",
      ...
      },
      {
        ...
        location: "Mannheim, Ludwigshafen",
        furniture: "-",
        community: "-",
