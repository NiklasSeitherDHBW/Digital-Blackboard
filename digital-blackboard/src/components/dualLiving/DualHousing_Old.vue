                ...
                <v-card>
                  ...
                  <v-card-title>{{selectedItem.raw.name}}</v-card-title>
                    ...
                    <v-btn @click="showDialogImages=false"
                            style="background-color: white; color: #E0001BFF;"
                            icon="mdi-close"
                           class="ml-auto mr-1"
                      size="30"/>
                  </v-row>
...
export default {
  data: () => ({
    ...
    contents: [
      ...
      { name: "Campo Novo Frauen-WG-Zimmer (zur Untermiete)",
        price: 530 ,
        available: "20.12.23 – 31.03.24",
      ...
      { name: "Untermieter aus der B-Phase gesucht",
        price: 540 ,
        available: "22.06.24-04.10.24",
      ...
      { name: "Dualer Student DHBW/ Suche Wohnung für erste Theoriephase / Untermiete",
        price: 450 ,
        available: "01.04.24 – 28.06.24",
      ...
      { name: "!SUCHE! Untermiete Wohnung in Mannheim",
        price: 450 ,
        available: "13.11.23 – 16.02.24",
      ...
      { name: "Dachgeschosswohnung im Altbauhaus",
        price: 800,
        available: "ab 15.09.23",
...
import AddApartment from "@/components/dualLiving/AddAppartment.vue"
</script>